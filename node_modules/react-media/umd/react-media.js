  ...
  */
  ...
  function (_React$Component) {
    ...
    function Media(props) {
      ...
      !(!(!props.query && !props.queries) || props.query && props.queries) ? invariant_1(false, '<Media> must be supplied with either "query" or "queries"') : void 0;
      !(props.defaultMatches === undefined || !props.query || typeof props.defaultMatches === "boolean") ? invariant_1(false, "<Media> when query is set, defaultMatches must be a boolean, received " + typeof props.defaultMatches) : void 0;
      !(props.defaultMatches === undefined || !props.queries || typeof props.defaultMatches === "object") ? invariant_1(false, "<Media> when queries is set, defaultMatches must be a object of booleans, received " + typeof props.defaultMatches) : void 0;
